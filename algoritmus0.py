...
for row in smooth_orientation:
        X = (row[0] - start)*t_span
        a.append(X)
        a.append(shift(row[1]-500, val_span_a, os_a))
        b.append(X)
